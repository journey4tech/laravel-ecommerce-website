              ...
              <form action="product_detail.html#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-lg-6 col-sm-6 col-xs-12">
                  <ul class="moreview" id="moreview">
                    <li class="moreview_thumb thumb_1"> <img class="moreview_thumb_image" src="https://via.placeholder.com/150" alt="thumbnail"> <img class="moreview_source_image" src="https://via.placeholder.com/150" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                    <li class="moreview_thumb thumb_2 moreview_thumb_active"> <img class="moreview_thumb_image" src="products-images/product4.jpg" alt="thumbnail"> <img class="moreview_source_image" src="products-images/product4.jpg" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                    <li class="moreview_thumb thumb_3"> <img class="moreview_thumb_image" src="https://via.placeholder.com/150" alt="thumbnail"> <img class="moreview_source_image" src="https://via.placeholder.com/150" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                    <li class="moreview_thumb thumb_4"> <img class="moreview_thumb_image" src="https://via.placeholder.com/150" alt="thumbnail"> <img class="moreview_source_image" src="https://via.placeholder.com/150" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                    <li class="moreview_thumb thumb_5"> <img class="moreview_thumb_image" src="https://via.placeholder.com/150" alt="thumbnail"> <img class="moreview_source_image" src="https://via.placeholder.com/150" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                    <li class="moreview_thumb thumb_6"> <img class="moreview_thumb_image" src="https://via.placeholder.com/150" alt="thumbnail"> <img class="moreview_source_image" src="https://via.placeholder.com/150" alt=""> <span class="roll-over">Roll over image to zoom in</span> <img  class="zoomImg" src="https://via.placeholder.com/150" alt="thumbnail"></li>
                  </ul>
                            ...
                            <div class="col-item">
                              ...
                              <div class="info">
                                <div class="info-inner">
                                  <div class="item-title"> <a href="product_detail.html#l" title=" Sample Product"> Sample Product </a> </div>
                                  <!--item-title-->
                      ...
                      <div id="upsell-products-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4"> 
                          ...
                          <div class="item">
                            <div class="col-item">
                              <div class="new-label new-top-right">New</div>
                              <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="products-images/product14.jpg" class="img-responsive" alt="a" /> </a>
                                <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="product_detail.html#" title="Add to cart">
                                  <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                                  </a> <a class="quick-view" href="quick_view.html">
                                  <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                          ...
                          <div class="item">
                            <div class="col-item">
                              <div class="new-label new-top-right">New</div>
                              <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="products-images/product18.jpg"> </a>
                                <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="product_detail.html#" title="Add to cart">
                                  <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                                  </a> <a class="quick-view" href="quick_view.html">
                                  <div><i class="icon-eye-open"></i><span>Quick view</span></div>
