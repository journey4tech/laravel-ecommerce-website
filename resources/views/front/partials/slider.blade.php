          ...
          <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
            <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
              <ul>
                ...
                <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('uploads/documents/sliderimages/'.$item->images)}}'><img src='{{asset('uploads/documents/sliderimages/'.$item->images)}}' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                  ...
                  {{--<div    class='tp-caption sfb  tp-resizeme ' data-x='45'  data-y='360'  data-endspeed='500'  data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4; white-space:nowrap;'><a href='index.html#' class="view-more">View More</a> <a href='index.html#' class="buy-btn">Buy Now</a></div>--}}
                ...
                {{-- <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset('frontEnd/assets/images/slider_img_2.jpg')}}' class="black-text"><img src='{{asset('frontEnd/assets/images/slide-img2.jpg')}}'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
