              ...
              <div class="slider-items slider-width-col4"> 
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{{asset('frontEnd/assets/products-images/product3.jpg')}}" class="img-responsive" alt="product-image" /> </a>
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="{{asset('frontEnd/assets/products-images/product4.jpg')}}"> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="index.html#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                        </a> <a class="quick-view" href="quick_view.html">
                        <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="{{asset('frontEnd/assets/products-images/product6.jpg')}}"> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="index.html#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                        </a> <a class="quick-view" href="quick_view.html">
                        <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="{{asset('frontEnd/assets/products-images/product7.jpg')}}"> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="index.html#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                        </a> <a class="quick-view" href="quick_view.html">
                        <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="{{asset('frontEnd/assets/products-images/product8.jpg')}}"> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="index.html#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                        </a> <a class="quick-view" href="quick_view.html">
                        <div><i class="icon-eye-open"></i><span>Quick view</span></div>
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="{{asset('frontEnd/assets/products-images/product9.jpg')}}"> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="index.html#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>Add to cart</span></div>
                        </a> <a class="quick-view" href="quick_view.html">
                        <div><i class="icon-eye-open"></i><span>Quick view</span></div>
