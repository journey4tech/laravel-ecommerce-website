                              ...
                              <div class="card-box">
                                  ...
                                  {!! Form::open(['url' => route('admin.categories.update',$category->id),'method'=>'PUT','enctype'=>"multipart/form-data"]) !!}
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="name" id="fullname" value="{{$category->name}}"  required="">
                                      </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <select class="form-control form-white" data-placeholder="Choose a color..." name="menu_id">
                                        ...
                                        <option  value="{{$data->id}}" {{$data->id==$category->menu_id?"selected":""}} >{{$data->name}}</option>
                                        @endforeach
                                       </select>
                                      </div>
