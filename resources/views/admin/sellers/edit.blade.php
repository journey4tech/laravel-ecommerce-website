    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
              <div class="col-lg-6">
                    <div class="card-box">
                        <h4 class="header-title m-t-0">Edit Account</h4>
                        <p class="text-muted font-14 m-b-20">

                        </p>

                        {!! Form::open(['url' => route('admin.sellers.update',$seller->id),'method'=>'PUT', 'enctype'=>"multipart/form-data", "autocomplete" =>"off"]) !!}
                            <div class="form-group row">
                                <label class="col-4 col-form-label">Name<span class="text-danger">*</span></label>
                                <div class="col-7">
                                    <input type="text" name="name" required="" class="form-control" placeholder="Seller Name" value="{{$seller->name}}">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="email" name="email" required="" class="form-control" placeholder="Seller Email" value="{{$seller->email}}">
                                    @if ($errors->has('email'))
                                    <ul class="parsley-errors-list filled">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="password" name="password_confirmation" class="form-control" placeholder="Set Password">
