                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                      {!! Form::open(['url' => route('admin.coupons.update',$coupon->id),'method'=>'PUT']) !!}

                                                        <div class="tab-content">
                                                            <div id="general" class="tab-pane fade active show">
                                                                <div class="form-group">
                                                                    <label class="control-label"> Name</label>
                                                                    <input class="form-control form-white" value="{{$coupon->name}}" placeholder="Enter name" type="text" name="name" />
                                                                </div>

                                                                <div class="form-group">
                                                                    <label class="control-label">Code</label>
                                                                    <input class="form-control form-white" value="{{$coupon->code}}" placeholder="Enter name" type="text" name="code" />
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-white" data-placeholder="Choose a color..." name="category">
                                                                        ...
                                                                        <option value="{{$data->id}}" {{$data->id==$coupon->category?'selected':''}} >{{$data->name}}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control form-white" data-placeholder="Choose a color..." name="product">
                                                                        ...
                                                                        <option value="{{$product->id}} "{{$product->id==$coupon->product?'selected':''}} >{{$product->product_name}}</option>
                                                                        @endforeach
                                                            ...
                                                            <div id="price" class="tab-pane fade">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control form-white" value="{{$coupon->value}}" placeholder="Enter name" type="number" name="value" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">Shiping</label>
                                                                    <input class="form-control form-white" value="{{$coupon->shiping}}" placeholder="Enter name" type="text" name="shiping" />
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="inputPassword4" class="col-form-label">Coupon Start Date</label>
                                                                    <input type="text" class="form-control" value="{{$coupon->start_date}}" name="start_date" data-provide="datepicker">

                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputPassword4"  class="col-form-label">Coupon Start End</label>
                                                                    <input type="text" name="end_date" value="{{$coupon->end_date}}" class="form-control" data-provide="datepicker">
                                                            ...
                                                            <div id="inventory" class="tab-pane fade">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control form-white" value="{{$coupon->coupon_limit}}" placeholder="Enter name" type="number" name="coupon_limit" />
                                                                </div>

                                                                <div class="form-group">
                                                                    <label class="control-label">Customer Limit</label>
                                                                    <input class="form-control form-white"  value="{{$coupon->customer_limit}}" placeholder="Enter name" type="number" name="customer_limit" />
